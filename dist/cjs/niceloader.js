...
exports.NiceLoader = void 0;
var core_1 = require("@babylonjs/core");
var glTF_1 = require("@babylonjs/serializers/glTF");
...
var NiceLoader = /** @class */ (function () {
    ...
    NiceLoader.prototype.uploadModel = function (scene, arr) {
        ...
        loadButton.onchange = function (evt) {
            ...
            core_1.FilesInput.FilesToLoad[filename.toLowerCase()] = blob;
        ...
        document.getElementById("exportButton").onclick = function (_e) {
            ...
            // Download GLB
            glTF_1.GLTF2Export.GLBAsync(scene, exportFileName, options).then(function (glb) {
                glb.downloadFiles();
            });
        };
    };
